...
const catalog: FruitProducts[] = [
  ...
  },
  {
    fruit: 'Ananas',
    products: [
      { name: 'Jus d’ananas', icon: ICON_DRINK },
      { name: 'Confiture d’ananas', icon: ICON_JAM },
      { name: 'Ananas séché', icon: ICON_DRIED },
      { name: 'Sirop d’ananas', icon: ICON_SYRUP },
      { name: 'Ananas au sirop (conserve)', icon: ICON_JAM },
    ],
  },
  {
    fruit: 'Banane',
    products: [
      { name: 'Banane séchée', icon: ICON_DRIED },
      { name: 'Farine de banane', icon: ICON_POWDER },
      { name: 'Chips de banane', icon: ICON_DRIED },
      { name: 'Confiture de banane', icon: ICON_JAM },
      { name: 'Purée de banane', icon: ICON_PUREE },
    ],
  },
  {
    fruit: 'Papaye',
    products: [
      { name: 'Jus de papaye', icon: ICON_DRINK },
      { name: 'Confiture de papaye', icon: ICON_JAM },
      { name: 'Papaye séchée', icon: ICON_DRIED },
      { name: 'Punch/nectar de papaye', icon: ICON_DRINK },
    ],
  },
  {
    fruit: 'Orange',
    products: [
      { name: 'Jus d’orange', icon: ICON_DRINK },
      { name: 'Confiture d’orange', icon: ICON_JAM },
      { name: 'Écorces d’orange confites', icon: ICON_JAM },
      { name: 'Sirop d’orange', icon: ICON_SYRUP },
    ],
  },
  {
    fruit: 'Citron',
    products: [
      { name: 'Jus de citron', icon: ICON_DRINK },
      { name: 'Sirop de citron', icon: ICON_SYRUP },
      { name: 'Citron confit', icon: ICON_JAM },
      { name: 'Poudre de citron séché', icon: ICON_POWDER },
    ],
  },
  {
    fruit: 'Goyave',
    products: [
      { name: 'Jus de goyave', icon: ICON_DRINK },
      { name: 'Confiture de goyave', icon: ICON_JAM },
      { name: 'Pâte de goyave', icon: ICON_JAM },
      { name: 'Goyave séchée', icon: ICON_DRIED },
    ],
  },
  {
    fruit: 'Tamarin',
    products: [
      { name: 'Jus de tamarin', icon: ICON_DRINK },
      { name: 'Sirop de tamarin', icon: ICON_SYRUP },
      { name: 'Confiture de tamarin', icon: ICON_JAM },
      { name: 'Pâte de tamarin', icon: ICON_JAM },
    ],
  },
  {
    fruit: 'Pastèque',
    products: [
      { name: 'Jus de pastèque', icon: ICON_DRINK },
      { name: 'Sirop de pastèque', icon: ICON_SYRUP },
      { name: 'Confiture de pastèque', icon: ICON_JAM },
    ],
  },
  {
    fruit: 'Bissap',
    products: [
      { name: 'Jus de bissap', icon: ICON_DRINK },
      { name: 'Sirop de bissap', icon: ICON_SYRUP },
      { name: 'Confiture de bissap', icon: ICON_JAM },
      { name: 'Bissap séché (fleurs)', icon: ICON_FLOWER },
    ],
  },
  {
    fruit: 'Gingembre',
    products: [
      { name: 'Jus de gingembre', icon: ICON_DRINK },
      { name: 'Sirop de gingembre', icon: ICON_SYRUP },
      { name: 'Poudre de gingembre', icon: ICON_POWDER },
      { name: 'Gingembre confit', icon: ICON_JAM },
    ],
  },
];
